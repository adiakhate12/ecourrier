...
def init_db():
    ...
    # 1. Nouvelle Table Utilisateur (Authentification par Matricule + Rôle)
    cursor.execute("""
        CREATE TABLE Utilisateur (
            matricule TEXT PRIMARY KEY,
            mot_de_passe TEXT NOT NULL,
            nom_complet TEXT NOT NULL,
            role TEXT NOT NULL -- 'Usager', 'Solde', 'Courrier', 'CallCenter'
        )
    """)
    ...
    comptes_test = [
        ...
        # Rôles administratifs et agents
    ...
    conn.commit()
    conn.close()
    print(" Système d'authentification par matricule initialisé avec succès !")
